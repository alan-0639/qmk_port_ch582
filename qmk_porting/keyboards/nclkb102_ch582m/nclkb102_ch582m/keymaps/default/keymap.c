...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = 
{
   ...
   [0] = LAYOUT_tkl_ansi (  
      QK_GESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   KC_HOME,  KC_END,    KC_CALC, KC_MYCM,   KC_CPNL,  MO(1),
   ...
   [1] = LAYOUT_tkl_ansi (
      BLE_ALL_CLEAR   , KC_TRNS   , KC_TRNS   , KC_TRNS   , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , RGB_HUI , RGB_HUD ,  KC_TRNS , KC_LPRN , KC_RPRN , KC_TRNS ,
